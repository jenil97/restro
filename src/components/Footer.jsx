...
const Footer = () => {
  ...
  return (
    <footer className="relative top-[10px] z-20 bg-dark lg:bg-transparent lg:min-h-[620px] lg:h-[678.5px] h-[860px] lg:bg-footer lg:bg-center lg:bg-no-repeat pt-20 lg:pt-32">
